...
if [ ! -d "${DATASET_DIR}" ]; then
  ...
  check_dataset_md5 'eda29a28edd75be6973e7d3b98c3b275' "${DATASET_1S_DIR}"
  ...
  check_dataset_md5 'd3f3849641cf9f955d23b8518a7f3bbf' "${DATASET_1S_DIR}"
  ...
  check_dataset_md5 '6ce2573e8f0501d3125646d7698c06c3'
